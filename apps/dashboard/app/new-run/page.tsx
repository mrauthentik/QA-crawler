  ...
  return (
    <div className="page-container page-container--hero">
      <div style={{ marginBottom: '64px', animation: 'fadeUp 0.5s ease forwards' }}>
        ...
        >
          Submit a URL. The detective crawls the app, generates test cases with AI, executes them with a real browser,
          and delivers a full investigation report.
        </p>
      </div>

      <div
        className="card scanlines form-card"
        style={{
      ...
      >
        ...
        <div style={{ marginTop: '24px' }}>
          ...
          <p
            className="font-mono"
            style={{ fontSize: '0.62rem', color: 'var(--text-muted)', marginTop: '6px', letterSpacing: '0.05em' }}
          >
        ...
        <div className="submit-row" style={{ marginTop: 0 }}>
          <button className="btn-primary" onClick={handleSubmit} disabled={loading} style={{ minWidth: '180px' }}>
            {loading ? (
