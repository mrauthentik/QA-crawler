...
var PORT = process.env.PORT || process.env.AUTH_PORT || 3002;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    app.listen(PORT, function () {
                        ...
                        console.log('╚══════════════════════════════════════════════╝');
                        console.log("\n\uD83D\uDE80 Auth service: http://localhost:".concat(PORT));
                        console.log("\u2764\uFE0F  Health:       http://localhost:".concat(PORT, "/health"));
                        console.log("\uD83D\uDD11 Login:         http://localhost:".concat(PORT, "/auth/login"));
                        console.log("\uD83C\uDF10 Google OAuth:  http://localhost:".concat(PORT, "/auth/google\n"));
                    });
                    return [3 /*break*/, 3];
                case 2:
                    err_1 = _a.sent();
                    console.error('❌ Failed to start auth service:', err_1);
                    process.exit(1);
                    return [3 /*break*/, 3];
